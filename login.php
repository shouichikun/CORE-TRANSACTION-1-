    ...
    if (empty($email) || empty($password)) {
        ...
        if (!$user) {
            ...
            if ($user['is_active'] == 0) {
                ...
                // =============================================
                // REGULAR USER - SHOW MODAL FIRST, SEND EMAIL VIA AJAX
                // =============================================
                // Generate OTP code
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* =============================================
           VERIFICATION MODAL - AESTHETIC & MODERN (NO SPINNER)
        ============================================= */
        .modal-overlay {
            display: none;
            position: fixed;
...
<script>
    ...
    // =============================================
    // 5. VERIFICATION MODAL - SHOW IMMEDIATELY, SEND EMAIL VIA AJAX
    // =============================================
    <?php if ($showModal): ?>
    (function() {
        ...
        // Show modal IMMEDIATELY - 0 delay
