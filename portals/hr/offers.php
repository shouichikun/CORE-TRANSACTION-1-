...
<body>
    ...
    <script>
        ...
        function openCreateModal() {
            ...
            document.getElementById('formAction').value = 'create_offer';
            document.getElementById('offerId').value = '0';
            document.getElementById('submitBtnText').textContent = 'Create Offer';
        ...
        function editOffer(id) {
            ...
            document.getElementById('formAction').value = 'update_offer';
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('applicationSelect').value = offer.application_id;
                    document.getElementById('offerDate').value = offer.offer_date;
                    document.getElementById('startDate').value = offer.start_date || '';
                    document.getElementById('salaryOffered').value = offer.salary_offered || '';
                    document.getElementById('benefits').value = offer.benefits || '';
