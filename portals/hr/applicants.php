    ...
    <div class="main-wrapper" id="mainWrapper">
        ...
        <header class="top-header">
            <div class="top-header-left">
                ...
                <span style="font-weight:600; font-size:0.875rem;">Applicants</span>
            </div>
    ...
    <script>
       ...
       function viewApplicant(applicationId) {
        ...
        function openInterviewModal(applicationId, applicantName) {
            ...
            document.getElementById('interviewDate').value = isoString;
        ...
        document.addEventListener('keydown', function(e) {
            if (e.key === 'Escape') {
                ...
                if (viewModal.classList.contains('active')) {
                    ...
                    closeModal('statusModal');
                } else if (interviewModal.classList.contains('active')) {
                    closeModal('interviewModal');
                } else {
                    closeMobileSidebar();
                    profileToggle.classList.remove('open');
