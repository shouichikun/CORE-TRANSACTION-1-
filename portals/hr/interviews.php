...
<body>
    ...
    <div class="main-wrapper" id="mainWrapper">
        <header class="top-header">
            <div class="top-header-left">
                ...
                <span style="font-weight:600; font-size:0.8125rem; color:var(--text-on-surface);">Interviews</span>
            </div>
    ...
    <script>
        ...
        function openScheduleModal() {
            ...
            document.getElementById('formAction').value = 'schedule_interview';
            document.getElementById('interviewId').value = '0';
            document.getElementById('submitBtnText').textContent = 'Schedule Interview';
        ...
        function editInterview(id) {
            ...
            document.getElementById('formAction').value = 'update_interview';
            document.getElementById('interviewId').value = id;
            document.getElementById('submitBtnText').textContent = 'Update Interview';
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('applicationSelect').value = interview.application_id;
                    document.getElementById('interviewDate').value = interview.interview_date.replace(' ', 'T');
                    ...
                    document.getElementById('interviewers').value = interview.interviewers || '';
